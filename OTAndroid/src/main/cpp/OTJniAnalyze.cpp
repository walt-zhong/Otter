...
/**
 * OTAnalyze Jni子类，用于获取Java/Kotlin具体实现实例类
 */
class GXJniAnalyze : public OTAnalyze {
...
public:
    ...
    void throwError(string message) override {
        __android_log_print(ANDROID_LOG_ERROR, "[SenseDyne]",
                            "%s", message.c_str());
    }
...
void GXJniAnalyze::initJniClass(jobject object_in) {
    ...
    if (env != nullptr) {
        ...
        analyze_fieldID = env->GetFieldID(clazz, "computeExtend",
                                          "Lcom/dynamic/otter/expression/analyze/OTAnalyze$IComputeExtend;");
...
Java_com_dynamic_otter_expression_analyze_OTAnalyze_00024Companion_getValueTag(JNIEnv *env,
                                                                                     jobject thiz,
                                                                                     jlong value) {
    OTValue *val = (OTValue *) value;
    return GX_VALUE_GET_TAG(*val);
}
extern "C"
JNIEXPORT jstring JNICALL
Java_com_dynamic_otter_expression_analyze_OTAnalyze_00024Companion_getValueString(JNIEnv *env,
                                                                                        jobject thiz,
                                                                                        jlong value) {
    OTValue *val = (OTValue *) value;
    const char *str = (*val).str;
    jstring j_str = env->NewStringUTF(str);
    if (val->tag == OT_TAG_STRING && val->str != NULL) {
        delete[]val->str;
        val->str = NULL;
    }
    return j_str;
...
Java_com_senseauto_sensedyne_expression_analyze_SDAnalyze_00024Companion_getValueBoolean(
...
Java_com_dynamic_otter_expression_analyze_OTAnalyze_00024Companion_getValueFloat(JNIEnv *env,
                                                                                       jobject thiz,
                                                                                       jlong value) {
    OTValue *val = (OTValue *) value;
...
Java_com_dynamic_otter_expression_analyze_OTAnalyze_00024Companion_getValueArray(JNIEnv *env,
                                                                                       jobject thiz,
                                                                                       jlong value) {
    OTValue *val = (OTValue *) value;
...
extern "C"
JNIEXPORT jobject JNICALL
Java_com_dynamic_otter_expression_analyze_OTAnalyze_00024Companion_getValueMap(JNIEnv *env,
                                                                                     jobject thiz,
                                                                                     jlong value) {
    OTValue *val = (OTValue *) value;
    return static_cast<jobject>(GX_VALUE_GET_OBJECT(*val));
...
Java_com_dynamic_otter_expression_analyze_OTAnalyze_00024Companion_getValueLong(JNIEnv *env,
                                                                                      jobject thiz,
                                                                                      jlong value) {
    OTValue *val = (OTValue *) value;
...
extern "C"
JNIEXPORT jlong JNICALL
Java_com_dynamic_otter_expression_analyze_OTAnalyze_00024Companion_createValueFloat64(
        JNIEnv *env, jobject thiz, jfloat value) {
    OTValue *result = new OTValue(OT_TAG_FLOAT, value);
    return (jlong) result;
}
extern "C"
JNIEXPORT jlong JNICALL
Java_com_dynamic_otter_expression_analyze_OTAnalyze_00024Companion_createValueString(
        JNIEnv *env, jobject thiz, jstring value) {
    jsize size = env->GetStringUTFLength(value);
    OTValue *result;
    if (size <= 0) {
        result = new OTValue(OT_TAG_STRING, "");
    } else {
        result = new OTValue(OT_TAG_STRING, env->GetStringUTFChars(value, JNI_FALSE));
    }
    return (jlong) result;
}
...
extern "C"
JNIEXPORT jlong JNICALL
Java_com_dynamic_otter_expression_analyze_OTAnalyze_00024Companion_createValueArray(
        JNIEnv *env, jobject thiz, jobject value) {
    //必须持有引用，否则会释放掉指针
    jobject ref = env->NewWeakGlobalRef(value);
    OTValue *result = new OTValue(OT_TAG_ARRAY, ref);
    return (jlong) result;
}
extern "C"
JNIEXPORT jlong JNICALL
Java_com_dynamic_otter_expression_analyze_OTAnalyze_00024Companion_createValueMap(JNIEnv *env,
                                                                                        jobject thiz,
                                                                                        jobject value) {
    //必须持有引用，否则会释放掉指针
    jobject ref = env->NewWeakGlobalRef(value);
    OTValue *result = new OTValue(OT_TAG_MAP, ref);
    return (jlong) result;
}
extern "C"
JNIEXPORT jlong JNICALL
Java_com_dynamic_otter_expression_analyze_OTAnalyze_00024Companion_createValueNull(
        JNIEnv *env, jobject thiz) {
    OTValue *result = new OTValue(OT_TAG_NULL, 1);
    return (jlong) result;
}
extern "C"
JNIEXPORT jlong JNICALL
Java_com_dynamic_otter_expression_analyze_OTAnalyze_00024Companion_createValueLong(
        JNIEnv *env, jobject thiz, jlong value) {
    OTValue *result = new OTValue(OT_TAG_LONG, (int64_t) value);
    return (jlong) result;
}

extern "C"
JNIEXPORT jlong JNICALL
Java_com_dynamic_otter_expression_analyze_OTAnalyze_getResultNative(JNIEnv *env, jobject thiz,
                                                                          jobject self,
                                                                          jstring expression,
                                                                          jobject data) {
...
Java_com_dynamic_otter_expression_analyze_OTAnalyze_initNative(JNIEnv *env, jobject thiz,
                                                                     jobject self) {
    //类
    GXJniAnalyze *jAnalyze = getJniAnalyze(env, self);
    //如果目前没有实例，则new一个实例
...
extern "C"
JNIEXPORT jboolean JNICALL
Java_com_dynamic_otter_expression_analyze_OTAnalyze_00024Companion_getValueBoolean(JNIEnv *env,
                                                                                   jobject thiz,jlong value) {
    OTValue *result = new OTValue(OT_TAG_BOOL, value);
    return (jlong) result;
}
extern "C"
JNIEXPORT jlong JNICALL
Java_com_dynamic_otter_expression_analyze_OTAnalyze_00024Companion_createValueBool(JNIEnv *env,
                                                                                   jobject thiz,
                                                                                   jboolean value) {
    OTValue *result = new OTValue(OT_TAG_BOOL, (int64_t) value);
    return (jlong) result;
}

extern "C"
JNIEXPORT void JNICALL
Java_com_dynamic_otter_expression_analyze_OTAnalyze_00024Companion_releaseOTValue(JNIEnv *env,
                                                                                  jobject thiz,
                                                                                  jlong value) {
