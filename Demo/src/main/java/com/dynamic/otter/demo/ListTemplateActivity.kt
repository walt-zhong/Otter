...
class ListTemplateActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val context = OTEngine.instance
            .init(this)
            .buildTemplate("list-demo", "list","templates/list-demo/list.xml")
        DataBinding.instance.buildTemplateData(
            AssetsUtils.parseAssetsToString(
                this,
                "templates/list-demo/mock-data/list.json"))
        val rootView = OTEngine.instance.createAndroidView(context)
        findViewById<LinearLayoutCompat>(R.id.list_container).addView(rootView)
    }
}